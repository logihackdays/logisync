...
namespace Emgu.CV
{
   ...
   /// </summary>
   [Serializable]
   public class EigenObjectRecognizerX
   {
      ...
      private EigenObjectRecognizerX()
      {
      }
      ...
      public EigenObjectRecognizerX(Image<Gray, Byte>[] images, ref MCvTermCriteria termCrit)
      ...
      /// <param name="termCrit">The criteria for recognizer training</param>
      public EigenObjectRecognizerX(Image<Gray, Byte>[] images, String[] labels, ref MCvTermCriteria termCrit)
      ...
      /// </param>
      /// <param name="termCrit">The criteria for recognizer training</param>
      public EigenObjectRecognizerX(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
      {
